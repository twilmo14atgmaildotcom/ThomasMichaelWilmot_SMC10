...
clear('UlnarDeviation', 'WristExtension', 'WristExtension_1kg', 'WristExtension_2kg');

%% If required remove recordings with errors

zworksp_idx(4:7)=[]; %These were removed due to subject error
...
% is not necessary. However if indices are required then comment out this
% section.
